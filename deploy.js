...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir hackathon-starter-1 && cp -r hackathon-starter-temp/* hackathon-starter-1/ && rm -rf hackathon-starter-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd hackathon-starter-1 && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
